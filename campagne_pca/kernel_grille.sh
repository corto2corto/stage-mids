...
# Usage : tmux new -s grille -d 'bash campagne_pca/kernel_grille.sh'
set -u
...

{
  ...
  $P -m campagne_pca.kernel_grille mediapart7j --pics _s3
  $P -m campagne_pca.kernel_grille lesechos7j  --pics _s3
  $P -m campagne_pca.kernel_grille lefigaro7j  --pics _s3
