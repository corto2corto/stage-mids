...
1. **La dimension.** Une fenêtre ±5 vit dans 10 dimensions, une ±50 dans
   100 : à structure égale, la petite fenêtre « gagne » mécaniquement. On
   normalise par le spectre plat (`gain6`).
2. **Les marges et la petite matrice.** Un témoin nul par **mélange de
   chaque colonne** (mêmes variances marginales par jour, corrélations
   temporelles détruites) définit `exces6` = cum6/cum6~nul~. Les scores
   spectaculaires des petites configurations (900 fenêtres, gain6 ≈ 6)
   retombent à 1,05 : c'était du bruit de petite matrice et des variances
   marginales.
3. **La composition.** Les moyennes par axe mélangent effet et taille
   d'échantillon : les comparaisons se font **à n apparié** (5 000 fenêtres
   sous-échantillonnées, tirage seedé, 3 graines — dispersion inter-graines
   médiane 0,0045, tous les écarts commentés sont significatifs).
