...
# Usage : tmux new -s grille3j -d 'bash campagne_pca/kernel_grille_3j.sh'
set -u
...

{
  ...
  $P -m campagne_pca.kernel_grille mediapart3j --demi 10 --seuil 5 --pics _s3
  $P -m campagne_pca.kernel_grille lesechos3j  --demi 10 --seuil 5 --pics _s3
  $P -m campagne_pca.kernel_grille lefigaro3j  --demi 10 --seuil 5 --pics _s3
