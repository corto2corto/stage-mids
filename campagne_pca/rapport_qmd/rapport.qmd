...
(`rupture/campagne.py`), journal complet (`rapport_qmd/suivi.md`), récoltes
(`data/resultats.csv`, 1 753 configs ; `data/resultats_rotation.csv`,
2 304 configs au double témoin), cache PCA (`data/cache_pca/`) et scripts de
figures (`scripts/figures_lib.py`, `scripts/figures.py`). Les données
intermédiaires (pics s3, séries 40k, base ngram Mediapart) sont sur gallica
dans `data/`.
