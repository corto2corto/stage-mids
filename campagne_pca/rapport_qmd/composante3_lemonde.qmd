...
def config(prefixe):
    ...
    seuil_vol, eligibles = lib.filtre_volume(d.volume, p["vol_q"], p["vol_min"], 12)
...
#| fig-cap: "Point rouge : le bloc du pic détecté (position 0) ; axe vertical en écarts-types de la fenêtre."
...
#| fig-cap: "Les douze sauts les plus alignés au seuil 5. Dix des douze fenêtres de la configuration A se retrouvent ici."
