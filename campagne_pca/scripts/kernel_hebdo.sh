...
# Usage : tmux new -s kernel -d 'bash campagne_pca/scripts/kernel_hebdo.sh'
set -u
...

{
  ...
  $P -m campagne_pca.scripts.kernel_hebdo mediapart7j --pics _s3
  $P -m campagne_pca.scripts.kernel_hebdo lesechos7j  --pics _s3
  $P -m campagne_pca.scripts.kernel_hebdo lefigaro7j  --pics _s3
  $P -m campagne_pca.scripts.kernel_hebdo lemonde7j
