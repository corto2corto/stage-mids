...
# Usage : tmux new -s lemonde_j -d 'bash campagne_pca/scripts/kernel_lemonde_journalier.sh'
set -u
...

{
  ...
  $P -m campagne_pca.scripts.kernel_grille lemonde --demi 15 --seuil 6 --mults 1
