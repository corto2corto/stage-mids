...
# Usage : .venv/bin/python -m campagne_pca.figures <commande> [options]
...
import campagne_pca.figures_lib as lib
from campagne_pca.figures_lib import AXE, ENCRE, ENCRE2, GRILLE, GRIS
...
def cmd_config(a):
    d = lib.charger(a.media, a.demi, a.seuil, a.pics, a.nettoie)
...
def cmd_synthese(a):
    ...
    r = pd.read_csv(os.path.join(lib.ICI, "resultats_rotation.csv"))
