...
![Point rouge : le bloc du pic détecté (position 0) ; axe vertical en écarts-types de la fenêtre. Produite par `campagne_pca/figures.py` (commande `comp`), même chaîne que la commande `config`.](figures/configA_comp3_archetypes.png){height=16.0cm}
