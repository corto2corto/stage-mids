...
![Point rouge : le bloc du pic détecté (position 0) ; axe vertical en écarts-types de la fenêtre. Produite par `figures_comp3.py`, même chaîne que `figures_config.py`.](figures/configA_comp3_archetypes.png){height=16.0cm}
