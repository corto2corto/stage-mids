...
Actuellement ne fonctionne pas, plusieurs choix :

- Utiliser les archives Gallica

- Prendre un abonnement

- Télécharger la version Chrome de l'extension de Bypass, et adapter le script

- Se limiter aux articles gratuits

### La Provence

Même cas que les Échos, le bypass échoue.
...
Même soucis qu'avec la Provence et les échos, le bypass échoue.
