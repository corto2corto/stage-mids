...
\[UPDATE\] Réussi avec l'extension Chrome
...
Il n'est pas possible d'accéder aux articles payants, mais de nombreux articles gratuits sont disponibles.

### Capital.fr

A tester, rachat par Bolloré

### Nice Matin 

A tester, rachat par Niel

### L'Express

A tester, A appartenu à Drahi (2006-2015), puis propriété de Alain Weill (2019-2023)

### Télérama 

A tester,Rachat par Le Monde, donc influencé par le changement d'actionnaire principaux.
